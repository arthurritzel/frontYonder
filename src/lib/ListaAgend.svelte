<script>
    ...
    <div class="bg-[#D4CDC5] p-10 rounded-2xl w-1/2">
            ...
            <div class="itens border-4 border-[#D4CDC5] border-b-black">
                <p class=" text-2xl p-1 flex justify-between">{dado.dia} | Usuario: {dado.usuario.nome} 
                </p>
                    
                    <button class="bg-red-600 p-2 rounded-xl" on:click={delet(dado.id, url)}>Deletar</button> <button class="bg-blue-600 p-2 rounded-xl" on:click={modal(dado.id)}>Visualizar</button>
